...
M1 = [67.74, 76.94, 80.34, 84.00, 85.94, 86.60]  # Random
M2 = [67.74, 68.55, 78.02, 83.75, 85.25, 85.54]  # Entropy
M3 = [67.74, 66.14, 69.10, 71.72, 73.06, 73.68]  # CoreSet
M4 = [67.74, 77.65, 80.44, 81.71, 86.21, 86.97]  # BADGE
M5 = [67.74, 77.03, 79.02, 79.05, 83.08, 85.33]  # UncertainGCN
M6 = [67.74, 78.57, 81.39, 84.38, 85.80, 86.59]  # CoreGCN
M7 = [67.74, 76.49, 79.50, 82.14, 85.79, 87.19]  # method
...
# 显示图像
plt.savefig('F:/Jetbrains/python/Projectzmm/picture/NEW-3D-CNN-PU.png')
plt.show()
print('~')
